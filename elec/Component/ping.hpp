...
// (DO NOT EDIT: machine generated header) 'Ping.pas' rev: 5.00
...
typedef void __fastcall (__closure *TPingDisplay)(System::TObject* Sender, System::TObject* Icmp, AnsiString 
	Msg);

typedef void __fastcall (__closure *TPingReply)(System::TObject* Sender, System::TObject* Icmp, int 
	Error);
